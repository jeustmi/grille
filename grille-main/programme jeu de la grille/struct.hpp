...
using tab_nb=std::array<int,128>;
using mat_nb=std::array<tab_nb,128>;
using tab_sl=std::array<char,128>;
using mat_sl=std::array<tab_sl,128>;
using tab_tri=std::array<int,3>;
using mat_tri=std::array<tab_tri,16384>;
